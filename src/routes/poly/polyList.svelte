<script>
	...
	let polyList = [ // 폴리 아래, 하위 폴리를 여러 개 두지 않고 하나의 카테고리만 만들 거면 굳이 필요없지만 하위 폴리를 여러 겹 둘거면 linked list의 구현이 필요할지도.
        {
            id:1,
            name:"DEBUG_POLY_1",
            category: [1, 3]
    ...
    let categoryList = [ // "categoryList" 이거 너무 catchy하지가 않아요 당신의 작명센스를 보여줘
        {
            id: 1,
            name: "CATEGORY_1",
            item: [1, 2]
